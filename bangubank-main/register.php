    ...
    <div class="flex flex-col justify-center min-h-full py-12 sm:px-6 lg:px-8">
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
        <div class="px-6 py-12 bg-white shadow sm:rounded-lg sm:px-12">
          <form
            class="space-y-6" action="./controller/registerController.php" method="POST" enctype="multipart/form-data">
            <div>
              ...
              <div class="mt-2">
                ...
                name="name" 
                type="text"
                 required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6 p-2" />
              </div>
            </div>
